...
import grpc.examples.bidirectionstreamstrings.StringsServiceGrpc;
 ...
 * </pre>
 */
@javax.annotation.Generated(value = "by gRPC proto compiler (version 1.15.0)", comments = "Source: .proto")
public final class StringServiceGrpc {
	...
	private static volatile io.grpc.MethodDescriptor<grpc.examples.bidirectionstreamstrings.StringRequest, grpc.examples.bidirectionstreamstrings.StringResponse> getReverseStreamMethod;

	@io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/'
			+ "reverseStream", requestType = grpc.examples.bidirectionstreamstrings.StringRequest.class, responseType = grpc.examples.bidirectionstreamstrings.StringResponse.class, methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
	public static io.grpc.MethodDescriptor<grpc.examples.bidirectionstreamstrings.StringRequest, grpc.examples.bidirectionstreamstrings.StringResponse> getReverseStreamMethod() {
		...
		if ((getReverseStreamMethod = StringServiceGrpc.getReverseStreamMethod) == null) {
			synchronized (StringServiceGrpc.class) {
				if ((getReverseStreamMethod = StringServiceGrpc.getReverseStreamMethod) == null) {
					StringServiceGrpc.getReverseStreamMethod = getReverseStreamMethod = io.grpc.MethodDescriptor.<grpc.examples.bidirectionstreamstrings.StringRequest, grpc.examples.bidirectionstreamstrings.StringResponse>newBuilder()
							.setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
							.setFullMethodName(generateFullMethodName("strings.StringsService", "reverseStream"))
							...
							.setSchemaDescriptor(new StringsServiceMethodDescriptorSupplier("reverseStream")).build();
				}
			}
		}
	 ...
	 */
	public static StringsServiceBlockingStub newBlockingStub(io.grpc.Channel channel) {
	 ...
	 * service
	 */
	public static StringsServiceFutureStub newFutureStub(io.grpc.Channel channel) {
	...
	public static abstract class StringsServiceImplBase implements io.grpc.BindableService {
		...
		public final io.grpc.ServerServiceDefinition bindService() {
			return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
					.addMethod(getReverseStreamMethod(), asyncBidiStreamingCall(
							new MethodHandlers<grpc.examples.bidirectionstreamstrings.StringRequest, grpc.examples.bidirectionstreamstrings.StringResponse>(
	...
	public static final class StringsServiceStub extends io.grpc.stub.AbstractStub<StringsServiceStub> {
		...
		private StringsServiceStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
			super(channel, callOptions);
		}

		@java.lang.Override
		protected StringsServiceStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
		...
		public io.grpc.stub.StreamObserver<grpc.examples.bidirectionstreamstrings.StringRequest> reverseStream(
				io.grpc.stub.StreamObserver<grpc.examples.bidirectionstreamstrings.StringResponse> responseObserver) {
			return asyncBidiStreamingCall(getChannel().newCall(getReverseStreamMethod(), getCallOptions()),
					responseObserver);
		}
	}
	...
	public static final class StringsServiceBlockingStub extends io.grpc.stub.AbstractStub<StringsServiceBlockingStub> {
		...
		private StringsServiceBlockingStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
			super(channel, callOptions);
		}

		@java.lang.Override
		protected StringsServiceBlockingStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
	...
	public static final class StringsServiceFutureStub extends io.grpc.stub.AbstractStub<StringsServiceFutureStub> {
		...
		private StringsServiceFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
			super(channel, callOptions);
		}

		@java.lang.Override
		protected StringsServiceFutureStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
	...
	private static final class StringsServiceFileDescriptorSupplier extends StringsServiceBaseDescriptorSupplier {
		StringsServiceFileDescriptorSupplier() {
		}
	}

	private static final class StringsServiceMethodDescriptorSupplier extends StringsServiceBaseDescriptorSupplier
			...
			synchronized (StringsServiceGrpc.class) {
				...
				if (result == null) {
					serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
							...
							.addMethod(getReverseStreamMethod()).build();
				}
			}
		}
		return result;
