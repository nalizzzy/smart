...
public class SensorGUI {
	...
	public SensorGUI() {
		...
		JLabel lblNewLabel_1 = new JLabel("Room Temperature");
		...
		JLabel lblNewLabel_2 = new JLabel("light sensor");
		...
		comboOperation.setModel(new DefaultComboBoxModel(new String[] { "degree", "status", "Availability" }));
		...
		btnCalculate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (index == 0) {
					textResponse.append("degree of the room " + String.valueOf(num1 + num2));
				}
				if (index == 1) {
