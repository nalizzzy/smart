...
public class StorageGUI {
	...
	public StorageGUI() {
		...
		JLabel lblNewLabel_1 = new JLabel("check full store");
		...
		JLabel lblNewLabel_2 = new JLabel("product checker");
		...
		comboOperation.setModel(new DefaultComboBoxModel(new String[] { "33", "0", "2" }));
		...
		btnCalculate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (index == 33) {
					textResponse.append("full stock " + String.valueOf(num1 + num2));
				}
				if (index == 0) {
					textResponse.append("empty" + String.valueOf(num1 - num2));
				}
				if (index == 2) {
